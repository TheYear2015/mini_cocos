...
class CCPluginCompile(cocos.CCPlugin):
    ...
    def _add_custom_options(self, parser):
        ...
        group.add_argument("--test", action="store_true", dest="script_test", default=False, help="Whether or not to test")
    ...
    def _check_custom_options(self, args):
        ...
        if args.compile_script is not None:
            ...
            self._compile_script = False

        self._script_test = args.script_test
    ...
    def compile_lua_scripts(self, src_dir, dst_dir, need_compile=None):
        ...
        if self._script_test:
            compile_cmd = "%s --test" % (compile_cmd)

        # run compile command
        self._run_cmd_clear(compile_cmd)
